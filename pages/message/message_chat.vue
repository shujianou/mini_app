...
<script>
var messageDate = require("@/common/message/js/message.js");
import leftMessage from "../../components/message/left-message.vue";
import rightMessage from "../../components/message/right-message.vue";
